...
public class PublicChatRoomsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 搜索框
		searching = (EditText)findViewById(cn.ucai.git.R.id.query);
		clean = (ImageButton)findViewById(cn.ucai.git.R.id.search_clear);
		searching.setHint(cn.ucai.git.R.string.search);
		...
		title = (TextView)findViewById(cn.ucai.git.R.id.tv_title);
		title.setText(getResources().getString(cn.ucai.git.R.string.chat_room));
...
//                                    footLoadingLayout.setVisibility(View.VISIBLE);
                            ...
                            if(isFirstLoading){
                                ...
                                if(chatRooms.size() < pagesize){
                                    ...
                                    footLoadingText.setText(getResources().getString(cn.ucai.git.R.string.no_more_messages));
                                }
                                adapter.notifyDataSetChanged();
                            }
                            isLoading = false;
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            pb.setVisibility(View.INVISIBLE);
                            footLoadingLayout.setVisibility(View.GONE);
                            Toast.makeText(PublicChatRoomsActivity.this, getResources().getString(cn.ucai.git.R.string.failed_to_load_data), 0).show();
                        }
                    });
                }
            }
	...
	private class ChatRoomAdapter extends ArrayAdapter<EMChatRoom> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) convertView.findViewById(cn.ucai.git.R.id.name)).setText(getItem(position).getName());
