...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.ucai.git.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.ucai.git.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.ucai.git.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.ucai.git.R.id.tv_nickname_description);
