...
import cn.ucai.git.activity.AlertDialog;
import cn.ucai.git.activity.BaiduMapActivity;
import cn.ucai.git.activity.ChatActivity;
import cn.ucai.git.activity.ContextMenu;
import cn.ucai.git.activity.ShowBigImage;
import cn.ucai.git.activity.ShowNormalFileActivity;
import cn.ucai.git.activity.ShowVideoActivity;
import cn.ucai.git.activity.UserProfileActivity;
import cn.ucai.git.task.LoadImageTask;
import cn.ucai.git.task.LoadVideoImageTask;
import cn.ucai.git.utils.DateUtils;
import cn.ucai.git.utils.ImageCache;
	...
	private void setUserAvatar(final EMMessage message, NetworkImageView imageView){
	    if(message.direct == Direct.SEND){
			...
			if (message.getChatType() == ChatType.GroupChat) {
				UserUtils.setUserAvatar(UserUtils.getAvatarUrl(message.getFrom()),imageView);
			}
