...
import cn.ucai.git.activity.GroupsActivity;
...
public class ContactlistFragment extends Fragment {
				    ...
				    getActivity().runOnUiThread(new Runnable(){
		                ...
		                public void run() {
		                    if(success){
		                        ...
		                        String s1 = getResources().getString(cn.ucai.git.R.string.get_failed_please_check);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.git.R.layout.fragment_contact_list, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		sidebar = (Sidebar) getView().findViewById(cn.ucai.git.R.id.sidebar);
		...
		ImageView addContactView = (ImageView) getView().findViewById(cn.ucai.git.R.id.iv_new_contact);
		// 进入添加好友页
		...
		progressBar = (View) getView().findViewById(cn.ucai.git.R.id.progress_bar);
	...
	private void setContactItemClickListener() {
		...
		query.setHint(cn.ucai.git.R.string.search);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.ucai.git.R.id.delete_contact) {
			try {
                // 删除此联系人
			...
			return true;
		}else if(item.getItemId() == cn.ucai.git.R.id.add_to_blacklist){
	...
	private void moveToBlacklist(final String username){
		final ProgressDialog pd = new ProgressDialog(getActivity());
		String st1 = getResources().getString(cn.ucai.git.R.string.Is_moved_into_blacklist);
		final String st2 = getResources().getString(cn.ucai.git.R.string.Move_into_blacklist_success);
		final String st3 = getResources().getString(cn.ucai.git.R.string.Move_into_blacklist_failure);
		pd.setMessage(st1);
		pd.setCanceledOnTouchOutside(false);
		pd.show();
		new Thread(new Runnable() {
