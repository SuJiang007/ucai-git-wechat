...
//					unreadAddressLable.setText(String.valueOf(count));
	...
	public class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {			
			...
			HashMap<String, Contact> contactList = FuliCenterApplication.getInstance().getMap();
			...
			return new Response.Listener<Contact>() {
				...
				public void onResponse(Contact contact) {
					if (contact != null && contact.isResult()) {
						HashMap<String, Contact> userList = FuliCenterApplication.getInstance().getMap();
						ArrayList<Contact> arrayList = FuliCenterApplication.getInstance().getContactArrayList();
		...
		public void onContactDeleted(final List<String> usernameList) {
			// 被删除
			Map<String, EMUser> localUsers = ((DemoHXSDKHelper)HXSDKHelper.getInstance()).getContactList();
			HashMap<String, Contact> map = FuliCenterApplication.getInstance().getMap();
		...
		private Response.Listener<Boolean> responseDeletContactListener(final String name) {
			return new Response.Listener<Boolean>() {
				...
				public void onResponse(Boolean aBoolean) {
					if (aBoolean) {
						FuliCenterApplication.getInstance().getMap().remove(name);
