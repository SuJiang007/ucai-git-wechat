 ...
 */
public class Boutique_DetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    Context context;
    ...
    public Boutique_DetailAdapter(Context context, ArrayList<NewGoodBean> arrayList,int sortBy) {
        this.sortBy = sortBy;
